                ...
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" name="name" value="<?= $challenge['name']; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="description" name="description" rows="5" value="<?= $challenge['description']; ?>"><?= $challenge['description']; ?></textarea>
